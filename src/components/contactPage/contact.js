...
import { devURL } from "../../../contents/endPoints";
        ...
        <div className="grid lg:grid-cols-2 grid-cols-1">
          ...
          <div className="lg:mb-0 mb-10">
            <div className="relative h-full">
              <img
                src="/images/minnerbanner05.jpg"
                alt="Contact Us"
                className="w-full h-full lg:rounded-l-2xl rounded-2xl object-cover"
              />
              <h1 className="absolute top-11 left-11 text-blue-500 text-4xl font-bold">
                Contact us
              </h1>
              <div className="absolute bottom-0 w-full lg:p-11 p-5">
                <div className="bg-white rounded-lg p-6">
                  <div className="flex items-center mb-6">
                    <h5 className="text-blue-500 font-bold text-base font-normal leading-6 ml-5">
                      1800-8894-207 (Toll free)
                    </h5>
                  </div>
                  <div className="flex items-center mb-6">
                    <h5 className="text-blue-500 font-bold text-base font-normal leading-6 ml-5">
          ...
          <div className="bg-gray-50 p-5 lg:p-11 lg:rounded-r-2xl rounded-2xl">
            <h2 className="text-blue-500 text-4xl font-semibold leading-10 mb-11">
              Send Us A Message
            </h2>
